...
const AdminCartView: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: 500, margin: "0 auto", background: "#fff", borderRadius: 10, boxShadow: "0 2px 12px #0001", padding: 24 }}>
      <h2>Carrito de Productos y Servicios</h2>
      {cart.length === 0 ? (
        ...
        <>
          ...
          <button style={{ marginTop: 16, background: "#43a047", color: "#fff", border: "none", borderRadius: 6, padding: "8px 18px", fontWeight: 500, marginLeft: 12 }} onClick={() => alert('Pago realizado con éxito')}>Pagar</button>
        </>
      )}
    </div>
  );
